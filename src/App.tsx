...
// Body.applyForce(circle, {x: 0, y: 0}, {x: 0, y: -0.001});
// World.add(engine.world, circle);

// const rect = Bodies.rectangle(304, 100, 150, 20);
// World.add(engine.world, rect);

// const rock = Bodies.fromVertices(400, 100, [[{x:0, y:0}, {x:150, y:0}, {x:150, y:20}, {x:0, y:20}]]);
// Body.applyForce(rock, {x: 0, y: 0}, {x: 0, y: -0.001});
...
function PhysicDiv({x0, y0, fposx, fposy, fx, fy, margin, style, children} : PropsWithChildren<PhysicDivProps>) {
    ...
    useEffect(() => {
        ...
        setTimeout(() => {  // NOTE divRef.current!.clientWidth is sometimes INCORRECT
            ...
            console.log(divRef.current!.clientWidth, children)
...
function App() {
    ...
    return (
        <div className='App'>
            ...
            <div>
                <PhysicDiv {...randPhysicDivProps()} style={{fontSize: '5em'}}>
